...
namespace coho {
class FullscreenQuadPipeline: Pipeline {
public:
...
bool FullscreenQuadPipeline::init(
        wgpu::Device device,
...
wgpu::RenderPipeline FullscreenQuadPipeline::getRenderPipeline() {
    return m_renderPipeline;
}

private:

bool FullscreenQuadPipeline::initBindings(wgpu::Device device, std::vector<wgpu::TextureView> textureViewArray) {
    ...
    bindGroupLayoutDesc.label = "bind group 1 label";
...
bool FullscreenQuadPipeline::initSampler(wgpu::Device device) {
