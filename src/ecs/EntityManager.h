...
public:
    ...
    int addEntity(std::shared_ptr<Entity> entity, std::shared_ptr<Renderer> renderModule);
    int addInstance(std::shared_ptr<Entity> entity, std::shared_ptr<Renderer> renderModule);
    void addDefaultMaterial(std::shared_ptr<Renderer> renderModule);
    int addMaterial(std::shared_ptr<Material> material, std::shared_ptr<Renderer> renderModule);
